...
while True:
    phrase = input("Please enter a word/phrase or 'quit' to exit: ").lower()
    if phrase == 'quit':
        break
    else:
...
input_month = input("Enter the month of the year (Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec): ").upper()
